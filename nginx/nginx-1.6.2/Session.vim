...
badd +45 src/os/unix/ngx_errno.c
badd +147 src/core/ngx_times.c
badd +27 src/os/unix/ngx_time.c
badd +40 src/os/unix/ngx_time.h
badd +79 src/os/unix/ngx_gcc_atomic_amd64.h
badd +378 src/core/ngx_regex.c
badd +46 src/core/ngx_regex.h
badd +15 src/core/ngx_list.c
badd +19 src/core/ngx_list.h
...
badd +71 src/core/ngx_cpuinfo.c
...
badd +22 src/os/unix/ngx_shmem.h
badd +48 /usr/include/netinet/tcp.h
badd +28 src/os/unix/ngx_socket.c
badd +99 src/os/unix/ngx_freebsd_config.h
badd +68 src/core/ngx_palloc.c
...
wincmd w
argglobal
edit ~/study/nginx/nginx-1.6.2/src/os/unix/ngx_process.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 394 - ((1 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
394
...
exe 'vert 1resize ' . ((&columns * 98 + 98) / 197)
exe 'vert 2resize ' . ((&columns * 98 + 98) / 197)
tabedit ~/study/nginx/nginx-1.6.2/src/core/ngx_cycle.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/study/nginx/nginx-1.6.2/src/core/ngx_cycle.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 756 - ((59 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
756
