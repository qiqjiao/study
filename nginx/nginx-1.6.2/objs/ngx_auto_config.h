#define NGX_CONFIGURE " --prefix=/home/qjiao/study/nginx/install --add-module=module/echo-nginx-module-0.54 --add-module=module/lua-nginx-module-0.9.10 --add-module=module/ngx_devel_kit --add-module=module/set-misc-nginx-module-0.24"
